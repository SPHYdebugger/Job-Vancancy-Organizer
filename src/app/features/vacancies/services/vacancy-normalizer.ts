...
export function normalizeVacancy(input: Partial<Vacancy> & Record<string, unknown>): Vacancy {
  ...
  return {
    ...
    domain: asNullableString(input.domain),
    location: asNullableString(input.location) ?? asNullableString(input.headquarters),
    headquarters: asNullableString(input.headquarters),
    ...
    salaryText: asNullableString(input.salaryText) ?? asNullableString(input['salary']),
    ...
    offerSource: asNullableString(input.offerSource),
    sourceType: (asString(input.sourceType) as Vacancy['sourceType']) ?? 'job_board',
    offerUrl: asNullableString(input.offerUrl),
    companyUrl: asNullableString(input.companyUrl),
    contactName: asNullableString(input.contactName),
    contactEmail: asNullableString(input.contactEmail),
    contactLinkedin: asNullableString(input.contactLinkedin),
    lastContactAt: asNullableString(input.lastContactAt) ?? asNullableString(input['contactDate']),
    applicationStatus,
    processStage: asNullableString(input.processStage),
    ...
    closureReason: asNullableString(input.closureReason),
    notes: asNullableString(input.notes),
    hrObservations: asNullableString(input.hrObservations),
